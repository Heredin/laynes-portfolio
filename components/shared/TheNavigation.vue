...
<template>
  ...
  <div
    ...
    class="font-Poppins-Regular m-0 sm:ml-4 mt-5 sm:mt-3 sm:flex p-5 sm:p-0 justify-center items-center shadow-lg sm:shadow-none"
  >
    <NuxtLink
      :to="$t('links.projects')"
    ...
    >
    <!-- <div
      class="font-Poppins-Regular border-t-2 pt-3 sm:pt-0 sm:border-t-0 border-primary-light dark:border-secondary-dark"
    >
      <button
        class="sm:hidden block text-left text-md bg-gray-700 hover:bg-gray-600 text-white shadow-sm rounded-md px-4 py-2 mt-2"
        @click="showModal()"
